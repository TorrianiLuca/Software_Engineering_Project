...
/**
 * Class that represents the cannon tile. It extends {@link ComponentTile}.
 */
public class Cannon extends ComponentTile {
    private final boolean isDouble;
    private boolean active;
    private final String cannonSide = "up";
     ...
     * @param numOfComponent is the number of cannons (one or two).
     */
    public Cannon(TileName name, String url, int l1, int l2, int l3, int l4, int numOfComponent) {
    ...
    /**
     * @return {@code true} if the cannon is double, {@code false} otherwise.
     */
