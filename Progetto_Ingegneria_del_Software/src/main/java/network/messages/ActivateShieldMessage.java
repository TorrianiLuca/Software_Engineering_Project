...
/**
 * Message that contains the coordinates of the shield the player wants to activate.
 */
public class ActivateShieldMessage extends Message {
    private Card card;
    private int col;
    private int row;
     ...
     */
    public ActivateShieldMessage(String clientId, Card card, int row, int col) {
        super(clientId);
        this.card = card;
        this.col = col;
        this.row = row;
    ...
    public void process(Controller controller) {
        controller.handleActivateShieldMessage(getClientId(), card, col, row);
    }
}