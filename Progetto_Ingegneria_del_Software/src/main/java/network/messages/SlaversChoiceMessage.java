...
import model.card.cardsType.Slavers;
 ...
 */
public class SlaversChoiceMessage extends Message {
    private Card card;
     ...
     */
    public SlaversChoiceMessage(String clientId, Card card) {
        super(clientId);
        this.card = card;
    }
    ...
    public void process(Controller controller) {
        controller.handleSlaversChoiceMessage(getClientId(), card);
    }
}