 ...
 */
public class Fase3ChoiceMessage extends Message {
    private Card card;
     ...
     */
    public Fase3ChoiceMessage(String clientId, Card card) {
        super(clientId);
        this.card = card;
    }
    ...
    public void process(Controller controller) {
        controller.handleFase3ChoiceMessage(getClientId(), card);
    }
}