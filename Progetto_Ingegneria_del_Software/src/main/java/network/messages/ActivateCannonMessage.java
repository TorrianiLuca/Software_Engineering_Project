 ...
 */
public class ActivateCannonMessage extends Message{
    private Card card;
    private int col;
    private int row;
     ...
     */
    public ActivateCannonMessage(String clientId, Card card, int row, int col) {
        super(clientId);
        this.card = card;
        this.col = col;
        this.row = row;
    ...
    public void process(Controller controller) {
        controller.handleActivateCannonMessage(getClientId(), card, col, row);
    }
}