...
import model.card.cardsType.AbandonedStation;
...
/**
 * Message that contains if the players wants to land on a station.
 */
public class AbandonedStationChoiceMessage extends Message {
    private Card card;
     ...
     */
    public AbandonedStationChoiceMessage(String clientId, Card card, String choice) {
        super(clientId);
        this.card = card;
        this.choice = choice;
    }
    ...
    public void process(Controller controller) {
        controller.handleAbandonedStationChoiceMessage(getClientId(), card, choice);
    }
}